(load "~/Programming/Scheme/sicp-exercises/chapter 3/section 3/queues.scm")
...
(define (alt-or-gate o1 o2 output)
  (let ((t1 (make-wire))
        (t2 (make-wire))
        (t3 (make-wire)))
    (inverter o1 t1)
...
(define (logical-or o1 o2)
  (cond ((or (= o1 1) (= o2 1)) 1)
        ((and (= o1 0) (= o2 0)) 0)
        (else (error "Invalid signals" o1 o2))))

; Agenda and time-segment definitions.
